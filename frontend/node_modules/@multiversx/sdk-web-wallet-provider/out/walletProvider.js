    ...
    */
    ...
    getTxSignReturnValue(urlParams) {
        ...
        for (let i = 0; i < expectedLength; i++) {
            ...
            } : {})), (urlParams["senderUsername"] && urlParams["senderUsername"][i] ? { senderUsername: urlParams["senderUsername"][i] } : {})), (urlParams["receiverUsername"] && urlParams["receiverUsername"][i] ? { receiverUsername: urlParams["receiverUsername"][i] } : {})), { signature: urlParams["signature"][i] }), (urlParams["relayer"] && urlParams["relayer"][i] ? { relayer: urlParams["relayer"][i] } : {})), (urlParams["relayerSignature"] && urlParams["relayerSignature"][i] ? { guardianSignature: urlParams["relayerSignature"][i] } : {})));
