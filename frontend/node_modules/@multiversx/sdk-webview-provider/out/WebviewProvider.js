...
class WebviewProvider {
    ...
    constructor(options) {
        ...
        this.signTransactions = (transactionsToSign) => __awaiter(this, void 0, void 0, function* () {
            ...
            return signedTransactions.map((tx) => sdk_core_1.Transaction.fromPlainObject(tx));
        });
        ...
        this.signMessage = (messageToSign) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new sdk_core_1.Message({
                ...
                address: (_c = messageToSign.address) !== null && _c !== void 0 ? _c : sdk_core_1.Address.fromBech32(this.account.address),
                signer: 'webview',
